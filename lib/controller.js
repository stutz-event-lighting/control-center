...
Controller.prototype.start = function(){
    ...
    async.parallel([
        ...
        this.addDevice("alloff",new AllOff(r1.ios[4],this.devices.mainlight,this.devices.officelight,this.devices.outdoorlight,[r1.relays[0],r1.relays[1]],this.devices.sonos));
        for(var ip in this.config.tablets){
            new Tablet(ip,"http://"+this.config.boxifyurl+this.config.tablets[ip]);
        }
...
Controller.prototype.setOutdoorTabletLEDState = function(){
    this.outdoorLightLED.set(checkDark(1,5),function(){})
}
