...
Controller.prototype.start = function(){
    ...
    async.parallel([
        ...
        this.addDevice("alloff",new AllOff(r1.ios[4],[r1.relays[0],r1.relays[1],r1.relays[4],r1.relays[5]],this.devices.officelight));
        ...
        this.officetablet = new Tablet("192.168.1.205","http://"+this.config.boxifyurl+"/tablet-office");
        this.stairstablet = new Tablet("192.168.1.207","http://"+this.config.boxifyurl+"/tablet-bistro");
