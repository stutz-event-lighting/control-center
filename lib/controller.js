...
Controller.prototype.start = function(){
    ...
    async.parallel([
        ...
        self.gate = new Gate(r1.ios[2],r2.ios[1],r2.ios[0],r1.relays[6],r1.relays[7],self.mainlight);
        self.officeLight = new OfficeLight(self.config.hueuser);
        self.alloff = new AllOff(r1.ios[4],[r1.relays[0],r1.relays[1],r1.relays[4],r1.relays[5]],self.officeLight);
        self.shutters = new Shutters(r2.relays[1],r2.relays[0]);
        self.tictactoe = new TicTacToe(self.config.hueuser,self.officeLight);
        ...
        server.add("officelight",self.officeLight);
        server.add("tictactoe",self.tictactoe);
    });
}
